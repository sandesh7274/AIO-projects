...
var Terminal = Terminal || function (cmdLineContainer, outputContainer) {
    ...
    const CMDS_ = [
        'about',  'clear', 'contact', 'github', 'menu', 'projects'
    ];
            ...
            switch (cmd) {
                case 'about':
                    if (args[0] == '-t' || args[0] == '-terminal') {
                        output(
                            ...
                            sandeshkolekar is hosted as a static page on firebase so every terminal command is executed as a browser-side script. 
                        ...
                        output(
                            ...
                            <p>I'm sandesh kolekar, a Bsc student in computer science . I am a web dev enthusiast.</p>
                            <p>I grew up in Mumbai. 
                            My hobbies include web dev and listening to music. 
                ...
                case 'contact':
                    output(
                        ...
                        <ul>
                            <li>Twitter: <a href="https://twitter.com/SandeshK7274" target="_blank">twitter/sandeshkolekar</a></li>
                            <li>Email: 
                            <div class="hintbox">
                                <a id="email${history_.length}" tabindex="0" onclick="copyToClipboard(\'Sandeshkolekar2004@gmail.com\');">
                                Sandeshkolekar2004@gmail.com</a>
                ...
                case 'close' :
                    ...
                    break;
                // case 'oldportfolio' :
                //     window.open('https://shivaylamba.me/Old-Portfolio/', '_blank');
                //     output('<p><a href="https://shivaylamba.me/Old-Portfolio/" target="_blank">https://shivaylamba.me/Old-Portfolio/</a></p>');
                //     break;
                case 'github':
                    window.open('https://github.com/sandesh7274', '_blank');
                    output('<p><a href="https://github.com/sandesh7274" target="_blank">https://github.com/sandesh7274</a></p>');
                    break;
                case 'ls':
                case 'dir':
                case 'help':
                ...
                case 'portfolio':
                    ...
                    break;
//                 case 'resume':
//                     window.open('assets/documents/ShivayLamba_CV.pdf', '_blank');
//                     output(`<p><a href="assets/documents/ShivayLamba_CV.pdf" target="_blank">Resumé</a><p>`);
//                     break;
                case 'date':
                    output(new Date());
                    break;
...
//                     window.open('assets/documents/Shivay_Lamba_DevRel.pdf', '_blank');
//                     output(`<p><a href="assets/documents/Shivay_Lamba_DevRel.pdf" target="_blank">Resumé</a><p>`);
                case 'su':
                    var root = 'root';
                    ...
                    if (root.match(/[-[\]'"`{}()<>*+?%,\\^$|#]/g)) {
                        ...
                        $('#input-line .prompt').html(`[<span class="user">${root}</span>@sandeshkolekar] > `);
                    }
                    break;
                case 'vim':
...
$(function () {
    ...
    $.getJSON('https://json.geoiplookup.io/', function (data) {
        ...
        delete data.cached;
        ipinfo = data;
        $('.prompt').html(`[<span class="user">${ipinfo.ip.length < 16 ? ipinfo.ip : 'user'}</span>@sandeshkolkear] > `);
    });
    // Set the command-line prompt to include the user's IP Address
    $('.prompt').html(`[<span class="user">user</span>@sandeshkolkear] > `);
